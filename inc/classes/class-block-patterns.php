	...
	public function register_block_patterns() {
		if ( function_exists( 'register_block_pattern' ) ) {
			...
			register_block_pattern(
				'got/cover',
				[
					'title' => __( 'GOT Cover', 'got' ),
					'description' => __( 'GOT Cover Block with image and text', 'got' ),
					'categories' => [ 'cover' ],
			...
			register_block_pattern(
				'got/two-columns',
				[
					'title' => __( 'GOT Two Column', 'got' ),
					'description' => __( 'GOT two columns with heading and text', 'got' ),
					'categories' => [ 'columns' ],
