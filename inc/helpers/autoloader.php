...
namespace GOT_THEME\Inc\Helpers;
...
function autoloader( $resource = '' ) {
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( GOT_DIR_PATH ), $directory, $file_name );
...
spl_autoload_register( '\GOT_THEME\Inc\Helpers\autoloader' );
